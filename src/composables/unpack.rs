...
pub struct UnpackC<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>,
                   CPt: Mat<T>, S: Gemm3Node<T, At, Bt, CPt, Xt>> {
    child: S,
    c_pack: CPt,
...
impl<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>, CPt: Mat<T>,
     S: Gemm3Node<T, At, Bt, CPt, Xt>> UnpackC<T, At, Bt, Ct, Xt, CPt, S>
    where CPt: ResizableBuffer<T> {
}
impl<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>, CPt: Mat<T>,
     S: Gemm3Node<T, At, Bt, CPt, Xt>>
    Gemm3Node<T, At, Bt, Ct, Xt> for UnpackC<T, At, Bt, Ct, Xt, CPt, S>
    where CPt: ResizableBuffer<T> {
    #[inline(always)]
    unsafe fn run(&mut self, a: &mut At, b: &mut Bt, c: &mut Ct, x: &mut Xt,
        ...
        self.child.run(a, b, &mut self.c_pack, x, thr);
        thr.barrier();
