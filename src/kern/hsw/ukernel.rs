...
pub struct Ukernel<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>>{
    _at: PhantomData<At>,
    _bt: PhantomData<Bt>,
    _ct: PhantomData<Ct>,
    _xt: PhantomData<Xt>,
...
impl<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>>
    Gemm3Node<T, At, Bt, Ct, Xt> for Ukernel<T, At, Bt, Ct, Xt> {
    #[inline(always)]
    ...
    fn new( ) -> Ukernel<T, At, Bt, Ct, Xt> {
        Ukernel {_at: PhantomData, _bt: PhantomData, _ct: PhantomData,
...
impl<Xt: Mat<f64>> Gemm3Node<f64, RowPanelMatrix<f64, U6>, ColumnPanelMatrix<f64, U8>, Matrix<f64>, Xt>
    for Ukernel<f64, RowPanelMatrix<f64, U6>, ColumnPanelMatrix<f64, U8>, Matrix<f64>, Xt> {
    #[inline(always)]
...
impl<Xt: Mat<f64>, K: Unsigned>
    Gemm3Node<f64, Hierarch<f64, U6, K, U1, U6>,
...
impl<Xt: Mat<f64>> Gemm3Node<f64, RowPanelMatrix<f64, U6>,
                             ColumnPanelMatrix<f64, U8>,
                             Hierarch<f64, U6, U8, U8, U1>, Xt> for
    Ukernel<f64, RowPanelMatrix<f64, U6>,
            ColumnPanelMatrix<f64, U8>,
            Hierarch<f64, U6, U8, U8, U1>, Xt> {
    #[inline(always)]
    unsafe fn run(&mut self,
                  a: &mut RowPanelMatrix<f64, U6>,
                  b: &mut ColumnPanelMatrix<f64, U8>,
...
impl<Xt: Mat<f64>, K: Unsigned>
    Gemm3Node<f64, Hierarch<f64, U4, K, U1, U4>,
                  Hierarch<f64, K, U12, U12, U1>,
                  Hierarch<f64, U4, U12, U12, U1>, Xt> for
    Ukernel<f64, Hierarch<f64, U4, K, U1, U4>,
                 Hierarch<f64, K, U12, U12, U1>,
                 Hierarch<f64, U4, U12, U12, U1>, Xt> {
    #[inline(always)]
    unsafe fn run(&mut self,
