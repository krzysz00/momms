...
pub struct Xsmm<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>> {
    _t: PhantomData<T>,
    _at: PhantomData<At>,
    _bt: PhantomData<Bt>,
    _ct: PhantomData<Ct>,
...
impl<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>>
    Gemm3Node<T, At, Bt, Ct, Xt> for Xsmm<T, At, Bt, Ct, Xt>
...
pub struct KernelXsmmA2<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>,
...
impl<T: Scalar, At: Mat<T>, Bt: Mat<T>, Ct: Mat<T>, Xt: Mat<T>,
     Nr: Unsigned, Mr: Unsigned>
    Gemm3Node<T, At, Bt, Ct, Xt> for KernelXsmmA2<T, At, Bt, Ct, Xt, Nr, Mr>
    where At: RoCM<T>, Bt: RoCM<T>, Ct: RoCM<T>
{
    #[inline(always)]
    default unsafe fn run(&mut self, a: &mut At, b: &mut Bt, c: &mut Ct,
    ...
    fn new() -> Self {
        KernelXsmmA2{ _t: PhantomData, _at: PhantomData, _bt: PhantomData, _ct: PhantomData,
                       _xt: PhantomData, _nrt: PhantomData, _mrt: PhantomData }
    }
    fn hierarchy_description() -> Vec<AlgorithmStep> {
